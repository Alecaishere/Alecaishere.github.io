    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center">
              <div className="relative w-16 h-16 mr-4 rounded-full overflow-hidden border-2 border-white">
                <Image src="/images/ALE-fondo.png" alt="Alejandro DM" fill className="object-cover" priority />
              </div>
              <div>
                <h1 className="text-3xl font-bold">Alejandro Delgado Morillo</h1>
                <p className="text-xl mt-2">{t.jobTitle}</p>
              </div>
            </div>
            <div className="mt-4 md:mt-0 flex gap-2">
              {/* <Link
                href="https://drive.google.com/file/d/1Y3ZoKZTEd07EHeFwXH7hj-eG-RJMVwbe/view?usp=sharing"
                target="_blank"
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <Tabs defaultValue="experience" className="w-full">
          <TabsList className="grid grid-cols-[repeat(auto-fit,minmax(80px,1fr))] gap-4 w-full">
            ...
            <TabsTrigger value="education">
              ...
              <span className="hidden sm:inline">{language === "es" ? "Formación" : "Education"}</span>
            </TabsTrigger>
          ...
          {/* Combined Education and Courses Tab */}
            ...
            <Card className="p-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="mt-4">
                    <h4 className="font-medium">{t.projects.functions.title}</h4>
                    <ul className="mt-2 space-y-1 list-disc list-inside">
                      {t.projects.functions.list.map((func, index) => (
      ...
      <footer className="bg-primary text-primary-foreground py-6 mt-auto">
        <div className="container mx-auto px-4 text-center">
          <p>© 2025 Alejandro DM</p>
          <div className="flex justify-center mt-4 space-x-4">
            <Link href="https://github.com/Alecaishere" target="_blank" rel="noopener noreferrer">
              <Button variant="ghost" size="icon" className="text-primary-foreground hover:bg-white hover:text-primary">
                <Github className="h-5 w-5" />
              </Button>
            </Link>
            <Link href="https://www.linkedin.com/in/alejandro-d-486070259/" target="_blank" rel="noopener noreferrer">
              <Button variant="ghost" size="icon" className="text-primary-foreground hover:bg-white hover:text-primary">
                <Linkedin className="h-5 w-5" />
              </Button>
            </Link>
            <Link href="https://t.me/Alecaishere" target="_blank" rel="noopener noreferrer">
              <Button variant="ghost" size="icon" className="text-primary-foreground hover:bg-white hover:text-primary">
